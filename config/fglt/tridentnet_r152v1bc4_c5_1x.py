...
def get_config(is_train):
    ...
    class DatasetParam:
        if is_train:
            image_set = ("bdd100k_train", )
        else:
            image_set = ("bdd100k_val", )
    ...
    class ModelParam:
        ...
        class pretrain:
            ...
            #prefix = 'experiments/tridentnet_r152v1bc4_c5_1x/checkpoint'
            epoch = 0
    ...
    class TestParam:
        ...
        class coco:
            annotation = "/media/data/Datasets2/bdd100k_json/annotations/bdd100k_labels_images_det_coco_val.json"
